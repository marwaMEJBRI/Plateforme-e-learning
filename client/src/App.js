...
import InfoLearner from "./pages/InfoLearner";
import AllCoursAdmin from "./pages/AllCoursAdmin";
    ...
    <div className="App">
      ...
      <Routes>
        ...
        <Route element={<ProtectedRouter />}>
          ...
          <Route path="/InfoLearner" element={<InfoLearner />}></Route>
          <Route path="/AllCoursAdmin" element={<AllCoursAdmin />}></Route>
          <Route
